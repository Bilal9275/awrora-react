...
// import TedAIWhitepaper from "../../../public/TedAI_Whitepaper.pdf";
    ...
    <div className={classes.bannerWrap}>
      ...
      >
        ...
        >
            ...
            <div className={classes.inner}>
              ...
              <Container>
                <Grid spacing={6} container alignItems="center">
                      ...
                      <div className={classes.text}>
                        <h4 className={text.title}>
                          ...
                          <span style={{ paddingLeft: "28px" }}>
                            {t("ai-landing.banner_highlight2")}
                          </span>
                        </h4>
                        ...
                        <div className={classes.btnArea}>
                          <Button
                            ...
                            color="primary"
                            variant="contained"
                            onClick={() => window.location.href = "https://ted-ai.netlify.app"}
                  ...
                  <Grid md={5} xs={12} style={{ paddingTop: "40px" }}>
                    <img src={ai} alt="Ai1" width={400} height={400} />
                  </Grid>
                </Grid>
              </Container>
            </div>
                    ...
                    <div className={classes.decoBanner}>
                      {isDesktop && (
                        <div className={classes.parallaxScene}>
                          <animated.div
                            style={{ transform: position.xy.to(trans1) }}
                          >
                          ...
                          <animated.div
                            style={{ transform: position.xy.to(trans2) }}
                          >
                          ...
                          <animated.div
                            style={{ transform: position.xy.to(trans3) }}
                          >
                          ...
                          <animated.div
                            style={{ transform: position.xy.to(trans4) }}
                          >
          ...
          <div
            className={cx(classes.slide, classes.centerContent)}
            data-slide-id="slide3"
          >
            <div className={classes.inner}>
              <Container>
                <Grid container justifyContent="center">
                  ...
                  <Grid item md={12} xs={12}>
                    <div className={cx(classes.img, classes.hBanner)}>
                      ...
                      <img src={imgAPI.ai[9]} alt="background" />
                    </div>
                  </Grid>
                </Grid>
              </Container>
